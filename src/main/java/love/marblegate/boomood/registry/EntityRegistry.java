...
import love.marblegate.boomood.entity.LlaberifEntity;
...
public class EntityRegistry {
    ...
    public static final RegistryObject<EntityType<LlaberifEntity>> LLABERIF = ENTITIES.register("llaberif",
            () -> EntityType.Builder.of(LlaberifEntity::new, MobCategory.MISC)
